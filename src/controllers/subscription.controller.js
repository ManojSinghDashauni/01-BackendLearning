...
const toggleSubscription = asyncHandler(async (req, res) => {
  ...
  if (!unSub) {
    throw new ApiError(400, "Error while unsubbing");
  }
  return res
    .status(200)
    .json(new ApiResponse(200, unSub, "UnSubed from Channel"));
});
...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, channelList, "Fetched Subscriber list"));
});
